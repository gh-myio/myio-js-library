-- =============================================================================
-- PRAIA DA COSTA L1 (Soul Malls) — Produto VIRTUAL "MQTT Sync" (plug)
-- Central: Praia da Costa L1 · CENTRAL_UUID ab589fee-b47b-4577-a7aa-016bf7e6f5b1
-- IPv6 (Yggdrasil): 200:8e12:1a64:71bc:ff06:5c56:9f09:f4aa
...
--     especializado 'MQTT Sync - ab589fee-b47b-4577-a7aa-016bf7e6f5b1'
...
--   UPDATE slaves   SET name = 'MQTT Sync - ab589fee-b47b-4577-a7aa-016bf7e6f5b1', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - ab589fee-b47b-4577-a7aa-016bf7e6f5b1', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - ab589fee-b47b-4577-a7aa-016bf7e6f5b1', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - ab589fee-b47b-4577-a7aa-016bf7e6f5b1', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - ab589fee-b47b-4577-a7aa-016bf7e6f5b1', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - ab589fee-b47b-4577-a7aa-016bf7e6f5b1', NULL, NULL, NULL, now(), now())
  RETURNING id
)
