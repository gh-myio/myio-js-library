-- =============================================================================
-- MACAÉ (Soul Malls) — Produto VIRTUAL "MQTT Sync" (plug)
-- Central: Macaé · CENTRAL_UUID 571ff592-8983-43b3-b7f2-96ab688d4f1c
-- IPv6 (Yggdrasil): 200:bf4f:c3a0:e697:17ff:28a5:38ae:536b
...
--     especializado 'MQTT Sync - 571ff592-8983-43b3-b7f2-96ab688d4f1c'
...
--   UPDATE slaves   SET name = 'MQTT Sync - 571ff592-8983-43b3-b7f2-96ab688d4f1c', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - 571ff592-8983-43b3-b7f2-96ab688d4f1c', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - 571ff592-8983-43b3-b7f2-96ab688d4f1c', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - 571ff592-8983-43b3-b7f2-96ab688d4f1c', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - 571ff592-8983-43b3-b7f2-96ab688d4f1c', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - 571ff592-8983-43b3-b7f2-96ab688d4f1c', NULL, NULL, NULL, now(), now())
  RETURNING id
)
