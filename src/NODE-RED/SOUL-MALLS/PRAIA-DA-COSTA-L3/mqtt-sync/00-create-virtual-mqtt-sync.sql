-- =============================================================================
-- PRAIA DA COSTA L3 (Soul Malls) — Produto VIRTUAL "MQTT Sync" (plug)
-- Central: Praia da Costa L3 · CENTRAL_UUID f476d770-675e-4730-8b73-afb6bba2060d
-- IPv6 (Yggdrasil): 200:af84:3511:6645:d746:a980:dc50:c849
...
--     especializado 'MQTT Sync - f476d770-675e-4730-8b73-afb6bba2060d'
...
--   UPDATE slaves   SET name = 'MQTT Sync - f476d770-675e-4730-8b73-afb6bba2060d', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - f476d770-675e-4730-8b73-afb6bba2060d', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - f476d770-675e-4730-8b73-afb6bba2060d', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - f476d770-675e-4730-8b73-afb6bba2060d', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - f476d770-675e-4730-8b73-afb6bba2060d', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - f476d770-675e-4730-8b73-afb6bba2060d', NULL, NULL, NULL, now(), now())
  RETURNING id
)
