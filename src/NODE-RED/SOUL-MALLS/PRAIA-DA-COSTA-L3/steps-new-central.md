# Setup MQTT Sync — Praia da Costa L3 (Soul Malls)
...
> [`SOUL-MALLS/PRAIA-DA-COSTA-L1/steps-new-central.md`](../PRAIA-DA-COSTA-L1/steps-new-central.md),
...
> | Campo | Valor |
> |---|---|
> | Central | Praia da Costa L3 |
> | Holding | Soul Malls |
> | IPv6 (mesh Yggdrasil) | `200:af84:3511:6645:d746:a980:dc50:c849` |
> | CENTRAL_UUID / Gateway ID | `f476d770-675e-4730-8b73-afb6bba2060d` |
...
> ⚠️ Não confundir com **Praia da Costa L1**, central irmã na mesma holding, com
> IPv6/UUID diferentes (`ab589fee-b47b-4577-a7aa-016bf7e6f5b1`).
...
```bash
scp -i id_rsa -r src/NODE-RED/SOUL-MALLS/PRAIA-DA-COSTA-L3/mqtt-sync \
  "root@[200:af84:3511:6645:d746:a980:dc50:c849]:/tmp/mqtt-sync"
```
...
--     'MQTT Sync - f476d770-675e-4730-8b73-afb6bba2060d' e addr_low dinâmico.
...
No editor (`http://[200:af84:3511:6645:d746:a980:dc50:c849]:8080/red`) → menu →
...
1. **env `CENTRAL_UUID` = `f476d770-675e-4730-8b73-afb6bba2060d`** definida no
...
`MQTT Sync - f476d770-675e-4730-8b73-afb6bba2060d` criado pelo gateway após o
...
- Central irmã: [`SOUL-MALLS/PRAIA-DA-COSTA-L1/steps-new-central.md`](../PRAIA-DA-COSTA-L1/steps-new-central.md)
