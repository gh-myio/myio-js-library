...
--
-- Naming por central: o slave pode chamar 'MQTT Sync' (legado) OU
-- 'MQTT Sync - <CENTRAL_UUID>' (especializado — ex.: pre-setup
-- a77ac87c-addd-4172-a65f-0f6f6038e98e). Por isso a busca usa LIKE.
...
BEGIN
  ...
  FROM slaves WHERE name LIKE 'MQTT Sync%' ORDER BY id LIMIT 1;
