-- =============================================================================
-- CAMPINAS G0 HIDRÔMETROS NOVO (Soul Malls) — Produto VIRTUAL "MQTT Sync" (plug)
-- Central: Campinas Shopping — G0 Hidrômetros Novo · CENTRAL_UUID 989671ae-345c-4416-90ed-20939e363ea0
-- IPv6 (Yggdrasil): 200:a2db:17c5:bb1c:afa1:2caa:c73:4312
...
--     especializado 'MQTT Sync - 989671ae-345c-4416-90ed-20939e363ea0'
...
--   UPDATE slaves   SET name = 'MQTT Sync - 989671ae-345c-4416-90ed-20939e363ea0', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - 989671ae-345c-4416-90ed-20939e363ea0', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - 989671ae-345c-4416-90ed-20939e363ea0', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - 989671ae-345c-4416-90ed-20939e363ea0', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - 989671ae-345c-4416-90ed-20939e363ea0', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - 989671ae-345c-4416-90ed-20939e363ea0', NULL, NULL, NULL, now(), now())
  RETURNING id
)
