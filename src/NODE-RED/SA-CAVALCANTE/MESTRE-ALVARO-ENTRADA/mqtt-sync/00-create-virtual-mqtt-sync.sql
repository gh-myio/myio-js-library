-- =============================================================================
-- MESTRE ÁLVARO ENTRADA (Sá Cavalcante) — Produto VIRTUAL "MQTT Sync" (plug)
-- Central: Mestre Álvaro — Entrada · CENTRAL_UUID e6e9484d-af12-4209-b0aa-510378e01c1e
-- IPv6 (Yggdrasil): 204:5b68:177a:540d:91c4:143b:d3b7:2ae2
...
--     especializado 'MQTT Sync - e6e9484d-af12-4209-b0aa-510378e01c1e'
...
--   UPDATE slaves   SET name = 'MQTT Sync - e6e9484d-af12-4209-b0aa-510378e01c1e', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - e6e9484d-af12-4209-b0aa-510378e01c1e', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - e6e9484d-af12-4209-b0aa-510378e01c1e', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - e6e9484d-af12-4209-b0aa-510378e01c1e', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - e6e9484d-af12-4209-b0aa-510378e01c1e', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - e6e9484d-af12-4209-b0aa-510378e01c1e', NULL, NULL, NULL, now(), now())
  RETURNING id
)
