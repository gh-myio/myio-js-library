-- =============================================================================
-- RIO POTY (Sá Cavalcante) — Produto VIRTUAL "MQTT Sync" (plug)
-- Central: Rio Poty · CENTRAL_UUID c0af8288-7b13-4024-bc11-df5017fef656
-- IPv6 (Yggdrasil): 203:bdfb:8fda:634d:c846:1404:f319:718c
...
--     especializado 'MQTT Sync - c0af8288-7b13-4024-bc11-df5017fef656'
...
--   UPDATE slaves   SET name = 'MQTT Sync - c0af8288-7b13-4024-bc11-df5017fef656', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - c0af8288-7b13-4024-bc11-df5017fef656', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - c0af8288-7b13-4024-bc11-df5017fef656', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - c0af8288-7b13-4024-bc11-df5017fef656', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - c0af8288-7b13-4024-bc11-df5017fef656', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - c0af8288-7b13-4024-bc11-df5017fef656', NULL, NULL, NULL, now(), now())
  RETURNING id
)
