# Setup MQTT Sync — Rio Poty (Sá Cavalcante)
...
> | IPv6 (mesh Yggdrasil) | `203:bdfb:8fda:634d:c846:1404:f319:718c` |
> | CENTRAL_UUID / Gateway ID | `c0af8288-7b13-4024-bc11-df5017fef656` |
...
```bash
scp -i id_rsa -r src/NODE-RED/SA-CAVALCANTE/RIO-POTY/mqtt-sync \
  "root@[203:bdfb:8fda:634d:c846:1404:f319:718c]:/tmp/mqtt-sync"
```
...
--     'MQTT Sync - c0af8288-7b13-4024-bc11-df5017fef656' e addr_low dinâmico.
...
No editor (`http://[203:bdfb:8fda:634d:c846:1404:f319:718c]:8080/red`) → menu →
...
1. **env `CENTRAL_UUID` = `c0af8288-7b13-4024-bc11-df5017fef656`** definida no
...
`MQTT Sync - c0af8288-7b13-4024-bc11-df5017fef656` criado pelo gateway após o
