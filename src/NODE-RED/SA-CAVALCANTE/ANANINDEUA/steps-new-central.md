# Setup MQTT Sync — Shopping Metrópole Ananindeua — SMT (Sá Cavalcante)
...
> | Campo | Valor |
> |---|---|
> | Central | Shopping Metrópole Ananindeua (SMT) |
> | Holding | Sá Cavalcante |
> | IPv6 (mesh Yggdrasil) | `201:ca6e:c33b:3a06:f4dd:d148:5d85:6315` |
> | CENTRAL_UUID / Gateway ID | `7ac0ac44-e631-4b64-ac1d-e9e93fe61e0a` |
...
```bash
scp -i id_rsa -r src/NODE-RED/SA-CAVALCANTE/ANANINDEUA/mqtt-sync \
  "root@[201:ca6e:c33b:3a06:f4dd:d148:5d85:6315]:/tmp/mqtt-sync"
```
...
--     'MQTT Sync - 7ac0ac44-e631-4b64-ac1d-e9e93fe61e0a' e addr_low dinâmico.
...
No editor (`http://[201:ca6e:c33b:3a06:f4dd:d148:5d85:6315]:8080/red`) → menu →
...
1. **env `CENTRAL_UUID` = `7ac0ac44-e631-4b64-ac1d-e9e93fe61e0a`** definida no
...
`MQTT Sync - 7ac0ac44-e631-4b64-ac1d-e9e93fe61e0a` criado pelo gateway após o
