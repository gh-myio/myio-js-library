-- =============================================================================
-- SHOPPING DA ILHA (Sá Cavalcante) — Produto VIRTUAL "MQTT Sync" (plug)
-- Central: Shopping da Ilha · CENTRAL_UUID cb318f02-1020-4f99-857f-d44d001d939b
-- IPv6 (Yggdrasil): 201:3447:911:5955:4018:3960:6838:ee12
...
--     especializado 'MQTT Sync - cb318f02-1020-4f99-857f-d44d001d939b'
...
--     status-sync.js da pasta pai (SHOPPING-DA-ILHA/).
--
...
--   UPDATE slaves   SET name = 'MQTT Sync - cb318f02-1020-4f99-857f-d44d001d939b', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - cb318f02-1020-4f99-857f-d44d001d939b', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - cb318f02-1020-4f99-857f-d44d001d939b', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - cb318f02-1020-4f99-857f-d44d001d939b', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - cb318f02-1020-4f99-857f-d44d001d939b', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - cb318f02-1020-4f99-857f-d44d001d939b', NULL, NULL, NULL, now(), now())
  RETURNING id
)
