# Setup MQTT Sync — Shopping da Ilha (Sá Cavalcante)
...
> | Campo | Valor |
> |---|---|
> | Central | Shopping da Ilha (SDI) |
> | Holding | Sá Cavalcante |
> | IPv6 (mesh Yggdrasil) | `201:3447:911:5955:4018:3960:6838:ee12` |
> | CENTRAL_UUID / Gateway ID | `cb318f02-1020-4f99-857f-d44d001d939b` |
...
```bash
scp -i id_rsa -r src/NODE-RED/SA-CAVALCANTE/SHOPPING-DA-ILHA/mqtt-sync \
  "root@[201:3447:911:5955:4018:3960:6838:ee12]:/tmp/mqtt-sync"
```
...
--     'MQTT Sync - cb318f02-1020-4f99-857f-d44d001d939b' e addr_low dinâmico.
...
No editor (`http://[201:3447:911:5955:4018:3960:6838:ee12]:8080/red`) → menu →
...
1. **env `CENTRAL_UUID` = `cb318f02-1020-4f99-857f-d44d001d939b`** definida no
...
`MQTT Sync - cb318f02-1020-4f99-857f-d44d001d939b` criado pelo gateway após o
