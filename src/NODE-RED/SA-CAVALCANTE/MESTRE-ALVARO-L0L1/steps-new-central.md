# Setup MQTT Sync — Mestre Álvaro L0L1 (Sá Cavalcante)
...
> | IPv6 (mesh Yggdrasil) | `200:ba5f:dacb:b278:8f85:acf4:f33c:f485` |
> | CENTRAL_UUID / Gateway ID | `45250d44-bad0-4071-aaa0-8091cfb12691` |
...
```bash
scp -i id_rsa -r src/NODE-RED/SA-CAVALCANTE/MESTRE-ALVARO-L0L1/mqtt-sync \
  "root@[200:ba5f:dacb:b278:8f85:acf4:f33c:f485]:/tmp/mqtt-sync"
```
...
--     'MQTT Sync - 45250d44-bad0-4071-aaa0-8091cfb12691' e addr_low dinâmico.
...
No editor (`http://[200:ba5f:dacb:b278:8f85:acf4:f33c:f485]:8080/red`) → menu →
...
1. **env `CENTRAL_UUID` = `45250d44-bad0-4071-aaa0-8091cfb12691`** definida no
...
`MQTT Sync - 45250d44-bad0-4071-aaa0-8091cfb12691` criado pelo gateway após o
