...
-- Central: Moxuara 2.0 ENTRADA-TRAFO (2026-07-13; banco restaurado da antiga e982edf9/202:1567…) · CENTRAL_UUID 6d7cd66a-c6dd-40df-b40b-e1bad295e424
-- IPv6 (Yggdrasil): 200:b2d6:a485:7a30:364b:424c:cafa:141c
...
--   UPDATE slaves   SET name = 'MQTT Sync - 6d7cd66a-c6dd-40df-b40b-e1bad295e424', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - 6d7cd66a-c6dd-40df-b40b-e1bad295e424', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - 6d7cd66a-c6dd-40df-b40b-e1bad295e424', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - 6d7cd66a-c6dd-40df-b40b-e1bad295e424', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - 6d7cd66a-c6dd-40df-b40b-e1bad295e424', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - 6d7cd66a-c6dd-40df-b40b-e1bad295e424', NULL, NULL, NULL, now(), now())
  RETURNING id
)
