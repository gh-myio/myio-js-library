-- =============================================================================
-- MESTRE ÁLVARO L3L4 (Sá Cavalcante) — Produto VIRTUAL "MQTT Sync" (plug)
-- Central: Mestre Álvaro L3L4 · CENTRAL_UUID fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e
-- IPv6 (Yggdrasil): 200:b0b1:81aa:49a4:c554:4fec:f110:9896
...
--     especializado 'MQTT Sync - fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e'
...
--   UPDATE slaves   SET name = 'MQTT Sync - fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e', NULL, NULL, NULL, now(), now())
  RETURNING id
)
