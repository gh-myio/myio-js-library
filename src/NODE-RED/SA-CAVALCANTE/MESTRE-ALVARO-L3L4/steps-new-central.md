# Setup MQTT Sync — Mestre Álvaro L3L4 (Sá Cavalcante)
...
> | IPv6 (mesh Yggdrasil) | `200:b0b1:81aa:49a4:c554:4fec:f110:9896` |
> | CENTRAL_UUID / Gateway ID | `fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e` |
...
```bash
scp -i id_rsa -r src/NODE-RED/SA-CAVALCANTE/MESTRE-ALVARO-L3L4/mqtt-sync \
  "root@[200:b0b1:81aa:49a4:c554:4fec:f110:9896]:/tmp/mqtt-sync"
```
...
--     'MQTT Sync - fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e' e addr_low dinâmico.
...
No editor (`http://[200:b0b1:81aa:49a4:c554:4fec:f110:9896]:8080/red`) → menu →
...
1. **env `CENTRAL_UUID` = `fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e`** definida no
...
`MQTT Sync - fcb3ccd1-4b85-4cef-a1de-0b8a80bec81e` criado pelo gateway após o
