# Setup MQTT Sync — Mestre Álvaro L2AC (Sá Cavalcante)
...
> | IPv6 (mesh Yggdrasil) | `200:8b:483c:9008:1184:caec:41b1:fa28` |
> | CENTRAL_UUID / Gateway ID | `d3202744-05dd-46d1-af33-495e9a2ecd52` |
...
```bash
scp -i id_rsa -r src/NODE-RED/SA-CAVALCANTE/MESTRE-ALVARO-L2AC/mqtt-sync \
  "root@[200:8b:483c:9008:1184:caec:41b1:fa28]:/tmp/mqtt-sync"
```
...
--     'MQTT Sync - d3202744-05dd-46d1-af33-495e9a2ecd52' e addr_low dinâmico.
...
No editor (`http://[200:8b:483c:9008:1184:caec:41b1:fa28]:8080/red`) → menu →
...
1. **env `CENTRAL_UUID` = `d3202744-05dd-46d1-af33-495e9a2ecd52`** definida no
...
`MQTT Sync - d3202744-05dd-46d1-af33-495e9a2ecd52` criado pelo gateway após o
