-- =============================================================================
-- MESTRE ÁLVARO L2AC (Sá Cavalcante) — Produto VIRTUAL "MQTT Sync" (plug)
-- Central: Mestre Álvaro L2AC · CENTRAL_UUID d3202744-05dd-46d1-af33-495e9a2ecd52
-- IPv6 (Yggdrasil): 200:8b:483c:9008:1184:caec:41b1:fa28
...
--     especializado 'MQTT Sync - d3202744-05dd-46d1-af33-495e9a2ecd52'
...
--   UPDATE slaves   SET name = 'MQTT Sync - d3202744-05dd-46d1-af33-495e9a2ecd52', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - d3202744-05dd-46d1-af33-495e9a2ecd52', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - d3202744-05dd-46d1-af33-495e9a2ecd52', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - d3202744-05dd-46d1-af33-495e9a2ecd52', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - d3202744-05dd-46d1-af33-495e9a2ecd52', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - d3202744-05dd-46d1-af33-495e9a2ecd52', NULL, NULL, NULL, now(), now())
  RETURNING id
)
