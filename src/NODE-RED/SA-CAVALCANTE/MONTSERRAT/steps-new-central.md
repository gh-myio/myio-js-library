# Setup MQTT Sync — Montserrat (Sá Cavalcante)
...
> | IPv6 (mesh Yggdrasil) | `200:abb2:e99:ec3d:eaf8:2d90:7bd9:42cc` |
> | CENTRAL_UUID / Gateway ID | `186bbdcb-95bc-4290-bf33-1ce89e48ffb4` |
...
```bash
scp -i id_rsa -r src/NODE-RED/SA-CAVALCANTE/MONTSERRAT/mqtt-sync \
  "root@[200:abb2:e99:ec3d:eaf8:2d90:7bd9:42cc]:/tmp/mqtt-sync"
```
...
--     'MQTT Sync - 186bbdcb-95bc-4290-bf33-1ce89e48ffb4' e addr_low dinâmico.
...
No editor (`http://[200:abb2:e99:ec3d:eaf8:2d90:7bd9:42cc]:8080/red`) → menu →
...
1. **env `CENTRAL_UUID` = `186bbdcb-95bc-4290-bf33-1ce89e48ffb4`** definida no
...
`MQTT Sync - 186bbdcb-95bc-4290-bf33-1ce89e48ffb4` criado pelo gateway após o
