-- =============================================================================
-- MONTSERRAT (Sá Cavalcante) — Produto VIRTUAL "MQTT Sync" (plug)
-- Central: Montserrat · CENTRAL_UUID 186bbdcb-95bc-4290-bf33-1ce89e48ffb4
-- IPv6 (Yggdrasil): 200:abb2:e99:ec3d:eaf8:2d90:7bd9:42cc
...
--     especializado 'MQTT Sync - 186bbdcb-95bc-4290-bf33-1ce89e48ffb4'
...
--   UPDATE slaves   SET name = 'MQTT Sync - 186bbdcb-95bc-4290-bf33-1ce89e48ffb4', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE channels SET name = 'MQTT Sync - 186bbdcb-95bc-4290-bf33-1ce89e48ffb4', updated_at = now() WHERE name = 'MQTT Sync';
--   UPDATE ambients SET name = 'MQTT Sync - 186bbdcb-95bc-4290-bf33-1ce89e48ffb4', updated_at = now() WHERE name = 'MQTT Sync';
-- ─────────────────────────────────────────────────────────────────────────────
...
new_slave AS (
  ...
  SELECT
    ...
    'MQTT Sync - 186bbdcb-95bc-4290-bf33-1ce89e48ffb4', NULL, '002-002-002-012',
...
new_channel AS (
  ...
  SELECT 'plug', 0, 'MQTT Sync - 186bbdcb-95bc-4290-bf33-1ce89e48ffb4', NULL, id, NULL, NULL,
...
new_ambient AS (
  ...
  VALUES ('MQTT Sync - 186bbdcb-95bc-4290-bf33-1ce89e48ffb4', NULL, NULL, NULL, now(), now())
  RETURNING id
)
