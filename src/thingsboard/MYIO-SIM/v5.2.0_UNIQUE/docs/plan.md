...
Baseado no arquivo src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/task.md:
...
Arquivo: src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/controller.js
...
- src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/controller.js - Agregar dados de status
...
- Editar src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/controller.js
...
| src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/controller.js | Agregar byStatus nos eventos               |
