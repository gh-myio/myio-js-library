/**
 * ThingsBoard Customer Server Scope Attributes Fetcher (JavaScript version)
 * 
 ...
 * @param {string} config.tbToken JWT token for authentication
 * @param {string} [config.baseUrl=''] Base URL for ThingsBoard API
 ...
 * ```
 */
export async function fetchThingsboardCustomerServerScopeAttrs(config) {
 ...
 * 
 * @param {any} payload Raw response from ThingsBoard API
 * @returns {Object} Normalized attributes map
 */
 ...
 * 
 * @param {Object} attributes Attributes map from fetchThingsboardCustomerServerScopeAttrs
 * @returns {Object} Extracted credentials with fallbacks
 * 
 * @example
 * ```javascript
 ...
 * ```
 */
export function extractMyIOCredentials(attributes) {
...
if (typeof window !== 'undefined') {
  window.fetchThingsboardCustomerServerScopeAttrs = fetchThingsboardCustomerServerScopeAttrs;
  window.fetchThingsboardCustomerAttrsFromStorage = fetchThingsboardCustomerAttrsFromStorage;
  window.extractMyIOCredentials = extractMyIOCredentials;
}
