...
function _deleteRow(id) {
  var row = _findRowById(id);
  if (!row) return;
  if (!confirm('Delete row "' + row.os + '"? This cannot be undone.')) return;
