...
Location: `src/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/DeviceGridWidgetFactory.js`
...
| File | Action |
|------|--------|
| `src/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/DeviceGridWidgetFactory.js` | CREATE |
| `src/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/controller.js` | EDIT - Export factory |
| `src/MYIO-SIM/v5.2.0/STORES/controller.js` | REPLACE (~60 lines) |
| `src/MYIO-SIM/v5.2.0/WATER_STORES/controller.js` | REPLACE (~70 lines) |
| `src/MYIO-SIM/v5.2.0/WATER_COMMON_AREA/controller.js` | REPLACE (~70 lines) |
| `src/MYIO-SIM/v5.2.0/EQUIPMENTS/controller.js` | REPLACE (~80 lines) |
