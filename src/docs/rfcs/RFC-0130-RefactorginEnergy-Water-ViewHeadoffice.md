...
| ------------------------------------------ | ------ | ------------------- |
| `src/MYIO-SIM/v5.2.0/MAIN/controller.js`   | ~7400  | Adicionar utilities |
| `src/MYIO-SIM/v5.2.0/ENERGY/controller.js` | ~1855  | Consumir utilities  |
| `src/MYIO-SIM/v5.2.0/WATER/controller.js`  | ~1636  | Consumir utilities  |
