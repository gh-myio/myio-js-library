@echo off
REM Schedule Holiday Showcase HTTP Server
REM Kills any existing process on port 8080 and starts a new server

set PORT=8080

echo ============================================
echo  Schedule Holiday Showcase Server
...
echo.
echo  Showcase URL:
echo  http://localhost:%PORT%/showcase/schedule-holiday/
echo.
echo  Prerequisites:
...
start "" "http://localhost:%PORT%/showcase/schedule-holiday/"
