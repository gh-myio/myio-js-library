@echo off
REM TelemetryGridShopping Showcase HTTP Server
...
REM Navigate to project root (two levels up from showcase\telemetry-grid-shopping)
cd /d "%~dp0..\.."
...
echo.
start "" "http://localhost:%PORT%/showcase/telemetry-grid-shopping/"
