#!/bin/bash
# CentralStatusCard Showcase HTTP Server
# Kills any existing process on port 3343 and starts a new server
...
# Navigate to project root (two levels up from showcase/central-status-card)
cd "$(dirname "$0")/../.."
