@echo off
REM Card Badges Showcase HTTP Server
REM Kills any existing process on port 3344 and starts a new server
...
REM Navigate to project root (two levels up from showcase\card-badges)
cd /d "%~dp0..\.."
...
echo.
start "" "http://localhost:%PORT%/showcase/card-badges/"
