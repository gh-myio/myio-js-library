@echo off
REM LibraryVersionChecker Showcase HTTP Server
...
REM Navigate to project root (two levels up from showcase\library-version-checker)
cd /d "%~dp0..\.."
...
echo Open showcase at: http://localhost:%PORT%/showcase/library-version-checker/
echo.
start "" "http://localhost:%PORT%/showcase/library-version-checker/"
