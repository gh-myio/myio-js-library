@echo off
REM ConsumptionTrendPanel Showcase HTTP Server
...
REM Navigate to project root (two levels up from showcase\consumption-trend-panel)
cd /d "%~dp0..\.."
...
echo Open showcase at: http://localhost:%PORT%/showcase/consumption-trend-panel/
echo.
start "" "http://localhost:%PORT%/showcase/consumption-trend-panel/"
