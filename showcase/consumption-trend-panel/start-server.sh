#!/bin/bash
# ConsumptionTrendPanel Showcase HTTP Server
# Kills any existing process on port 3335 and starts a new server
...
# Navigate to project root (two levels up from showcase/consumption-trend-panel)
cd "$(dirname "$0")/../.."
