@echo off
REM EnergyPanel Showcase HTTP Server
...
REM Navigate to project root (two levels up from showcase\energy-panel)
cd /d "%~dp0..\.."
...
echo.
start "" "http://localhost:%PORT%/showcase/energy-panel/"
