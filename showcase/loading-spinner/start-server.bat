@echo off
REM LoadingSpinner Showcase HTTP Server
...
REM Navigate to project root (two levels up from showcase\loading-spinner)
cd /d "%~dp0..\.."
...
echo Open showcase at: http://localhost:%PORT%/showcase/loading-spinner/
echo.
start "" "http://localhost:%PORT%/showcase/loading-spinner/"
