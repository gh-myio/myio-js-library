#!/bin/bash
# Annotations Showcase HTTP Server
...
# Navigate to project root (two levels up from showcase/annotations)
cd "$(dirname "$0")/../.."
...
echo "Open showcase at: http://localhost:$PORT/showcase/annotations/"
