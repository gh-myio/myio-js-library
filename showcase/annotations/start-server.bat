@echo off
REM Annotations Showcase HTTP Server
...
REM Navigate to project root (two levels up from showcase\annotations)
cd /d "%~dp0..\.."
...
echo.
start "" "http://localhost:%PORT%/showcase/annotations/"
