...
Perfect! I've successfully added the new RFC-0130 utilities to the `src/thingsboard/MYIO-SIM/v5.2.0/MAIN/controller.js` file. Here's a summary of what was added:
