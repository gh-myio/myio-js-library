...
**Reference:** `src/thingsboard/MYIO-SIM/V1.0.0/MENU/controller.js`
...
```css
/* src/thingsboard/MYIO-SIM/V1.0.0/EQUIPMENTS/style.css */
...
- MENU Widget Implementation: `src/thingsboard/MYIO-SIM/V1.0.0/MENU/controller.js`
