...
**Location:** `src/thingsboard/MYIO-SIM/V1.0.0/FOOTER/style.css`
...
```css
/* src/thingsboard/MYIO-SIM/V1.0.0/FOOTER/style.css */
...
```html
<!-- src/thingsboard/MYIO-SIM/V1.0.0/FOOTER/template.html -->
...
**Location:** `src/thingsboard/MYIO-SIM/V1.0.0/MAIN/controller.js`
...
```javascript
/* src/thingsboard/MYIO-SIM/V1.0.0/MAIN/controller.js */
...
```javascript
/* src/thingsboard/MYIO-SIM/V1.0.0/FOOTER/controller.js */
...
**Location:** `src/thingsboard/MYIO-SIM/V1.0.0/MAIN/style.css` or parent layout
