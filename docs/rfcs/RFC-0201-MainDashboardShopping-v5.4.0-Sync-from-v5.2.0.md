...
| Path | Change |
|---|---|
| `docs/rfcs/RFC-0201-MainDashboardShopping-v5.4.0-Sync-from-v5.2.0.md` | **Create** — this document |
...
| `docs/ONBOARDING-ECOSYSTEM-GCDR-ALARMS.md` | **Edit (Phase 1 follow-up)** — document the new v-5.4.0 wiring patterns (orchestrator construction order, `gcdrDeviceId` chain, mock orchestrators in showcase) |
