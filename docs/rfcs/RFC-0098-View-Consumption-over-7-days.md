...
Currently, both `ENERGY` and `WATER` widgets in `src/thingsboard/MYIO-SIM/v5.2.0/` implement their own 7-day consumption charts with duplicated logic. This leads to:
