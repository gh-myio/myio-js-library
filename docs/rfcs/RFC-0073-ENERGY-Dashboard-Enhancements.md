...
**Location:** `src/thingsboard/MYIO-SIM/V1.0.0/ENERGY/controller.js`
...
```html
<!-- src/thingsboard/MYIO-SIM/V1.0.0/ENERGY/template.html -->
...
```css
/* src/thingsboard/MYIO-SIM/V1.0.0/ENERGY/style.css */
...
- EQUIPMENTS Widget Implementation: `src/thingsboard/MYIO-SIM/V1.0.0/EQUIPMENTS/controller.js`
