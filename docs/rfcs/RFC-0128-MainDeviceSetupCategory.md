...
2. Update import paths in:
   - `src/index.ts`
   - `src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/controller.js`
...
| `src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/controller.js` | MODIFY | Use new classification functions |
