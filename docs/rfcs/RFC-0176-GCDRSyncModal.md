...
**File**: `src/thingsboard/Pre-Setup-Constructor/v.1.0.9/controller.js`
...
- **RFC document**: `docs/rfcs/RFC-0176-GCDRSyncModal.md`
- **Integration file**: `src/thingsboard/Pre-Setup-Constructor/v.1.0.9/controller.js`
