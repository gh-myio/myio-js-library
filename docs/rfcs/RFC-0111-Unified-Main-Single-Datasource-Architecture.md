...
- `src/thingsboard/MYIO-SIM/v5.2.0/MAIN/` - Old MAIN widget
- `src/thingsboard/MYIO-SIM/v5.2.0/MENU/` - Old MENU widget (now a library component)
...
Located at: `src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/`
...
- `src/thingsboard/MYIO-SIM/v5.2.0/MENU/` - Old MENU widget (keep untouched, now a library component)
