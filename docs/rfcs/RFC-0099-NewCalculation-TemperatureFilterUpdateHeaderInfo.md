...
|-----------|----------|------|
| MENU | `src/thingsboard/MYIO-SIM/v5.2.0/MENU` | Emits filter selection events |
| MAIN | `src/thingsboard/MYIO-SIM/v5.2.0/MAIN` | Orchestrates data flow and calculations |
| HEADER | `src/thingsboard/MYIO-SIM/v5.2.0/HEADER` | Renders comparison display |
