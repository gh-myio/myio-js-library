...
**File:** `src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/controller.js`
...
| `src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/controller.js` | Add filter event handler |
...
- Legacy: `src/thingsboard/MYIO-SIM/v5.2.0/MENU/controller.js` (lines 48-86, 440-467)
- Legacy: `src/thingsboard/MYIO-SIM/v5.2.0/MAIN/controller.js` (lines 6595-6664)
