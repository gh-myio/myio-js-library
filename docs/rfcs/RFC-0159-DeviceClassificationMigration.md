...
- `src/thingsboard/MYIO-SIM/v5.2.0/MAIN/controller.js` (remove ~400 lines, manter exposição via MyIOUtils)
- `src/thingsboard/MYIO-SIM/v5.2.0/WATER_STORES/controller.js` (opcional: remover `isWaterStoreDevice` duplicada)
- `src/thingsboard/MYIO-SIM/v5.2.0/STORES/controller.js` (manter funções locais - são diferentes)

**Sem impacto:**
- `src/thingsboard/MYIO-SIM/v5.2.0/EQUIPMENTS/controller.js`
- `src/thingsboard/MYIO-SIM/v5.2.0/WATER_COMMON_AREA/controller.js`
