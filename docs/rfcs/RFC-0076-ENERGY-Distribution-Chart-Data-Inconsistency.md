...
- **RFC PR**: N/A
- **Status**: Draft
- **Implementation Path**: `src/thingsboard/MYIO-SIM/V1.0.0/ENERGY/controller.js`
...
**Check in MAIN orchestrator** (`src/thingsboard/MYIO-SIM/V1.0.0/MAIN/controller.js`):
```javascript
// Ensure energyCache includes all device types
// Verify MyIOOrchestrator.getEnergyCache() returns complete data
```

**Check in ENERGY widget** (`src/thingsboard/MYIO-SIM/V1.0.0/ENERGY/controller.js`):
```javascript
...
**Files to Modify**:
- `src/thingsboard/MYIO-SIM/V1.0.0/ENERGY/controller.js`
...
- **EQUIPMENTS Widget**: `src/thingsboard/MYIO-SIM/V1.0.0/EQUIPMENTS/controller.js`
- **ENERGY Widget**: `src/thingsboard/MYIO-SIM/V1.0.0/ENERGY/controller.js`
- **MAIN Orchestrator**: `src/thingsboard/MYIO-SIM/V1.0.0/MAIN/controller.js`
- **MENU Widget**: `src/thingsboard/MYIO-SIM/V1.0.0/MENU/controller.js`
- **Log File**: `dashboard.myio-bas.com-1762809149745.log`
- **Log Cleaner**: `src/thingsboard/MYIO-SIM/V1.0.0/clean-log.ps1`
