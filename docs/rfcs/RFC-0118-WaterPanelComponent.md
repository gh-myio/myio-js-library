...
This RFC documents the reverse-engineering of the existing WATER widget (`src/thingsboard/MYIO-SIM/v5.2.0/WATER/`) and proposes extracting its functionality into a reusable **WaterPanelComponent** in the MYIO library. The water panel provides consumption summary cards, time-series charts, and distribution visualizations for the Head Office dashboard.
...
The existing WATER widget (`src/thingsboard/MYIO-SIM/v5.2.0/WATER/`) is a ThingsBoard widget that provides:
...
```
src/thingsboard/MYIO-SIM/v5.2.0/WATER/
...
- `src/thingsboard/MYIO-SIM/v5.2.0/WATER/controller.js` (~1600 lines)
