...
The existing HEADER widget (`src/thingsboard/MYIO-SIM/v5.2.0/HEADER/`) is a ThingsBoard widget that provides:
...
```
src/thingsboard/MYIO-SIM/v5.2.0/HEADER/
...
- `src/thingsboard/MYIO-SIM/v5.2.0/HEADER/controller.js` (~1200+ lines)
