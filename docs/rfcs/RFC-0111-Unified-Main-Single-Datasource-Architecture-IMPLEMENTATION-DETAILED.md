...
- `src/thingsboard/MYIO-SIM/v5.2.0/MAIN/` - Old MAIN widget (keep untouched)
- `src/thingsboard/MYIO-SIM/v5.2.0/MENU/` - Old MENU widget (keep untouched)
...
**Location**: `src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/`
...
| File | Purpose |
|------|---------|
| `src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/template.html` | Layout with library component containers |
| `src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/controller.js` | Orchestrator + library calls |
| `src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/styles.css` | Layout styles + panel modal |
| `src/thingsboard/MYIO-SIM/v5.2.0/MAIN_UNIQUE_DATASOURCE/settingsSchema.json` | darkMode/lightMode config |

### To Modify

| File | Change |
|------|--------|
| `src/thingsboard/MYIO-SIM/v5.2.0/TELEMETRY/controller.js` | Add `myio:telemetry-config-change` listener |

### ⛔ Do NOT Modify (Legacy - Old Architecture)

| File | Reason |
|------|--------|
| `src/thingsboard/MYIO-SIM/v5.2.0/MAIN/` | Old widget - create MAIN_UNIQUE_DATASOURCE instead |
| `src/thingsboard/MYIO-SIM/v5.2.0/MENU/` | Old widget - now a library component |
