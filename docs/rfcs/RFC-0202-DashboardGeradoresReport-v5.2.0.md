...
- **Inspired by**:
  ...
  - `src/thingsboard/Generator/` — generator SVG icon + status binding
  - `src/thingsboard/GCDR-Upsell-Setup/v.1.0.0/controller.js` — timeseries edit/delete pattern
...
- `src/thingsboard/GCDR-Upsell-Setup/v.1.0.0/controller.js` — reference for the request glue (auth headers, error handling).
...
| Generator SVG icon              | `src/thingsboard/Generator/template.html`                                                                     |
| Telemetry edit/delete           | `src/thingsboard/GCDR-Upsell-Setup/v.1.0.0/controller.js`                                                    |
