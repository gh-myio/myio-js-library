...
The existing ENERGY widget (`src/thingsboard/MYIO-SIM/v5.2.0/ENERGY/`) is a ThingsBoard widget that provides:
...
```
src/thingsboard/MYIO-SIM/v5.2.0/ENERGY/
...
- `src/thingsboard/MYIO-SIM/v5.2.0/ENERGY/controller.js` (~2000 lines)
