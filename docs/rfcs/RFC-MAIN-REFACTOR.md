...
## Objetivo
Reduzir o tamanho do arquivo `src/thingsboard/MYIO-SIM/v5.2.0/MAIN/controller.js` (~5400 linhas) movendo funções genéricas e reutilizáveis para a biblioteca `myio-js-library`.
