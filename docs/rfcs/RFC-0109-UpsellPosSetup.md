...
- **Target File:** `src/thingsboard/Pre-Setup-Constructor/v.1.0.9/controller.js`
...
Reference: `src/thingsboard/Pre-Setup-Constructor/v.1.0.9/KNOWLEDGE.md`
...
| File | Description |
|------|-------------|
| `src/thingsboard/GCDR-Upsell-Setup/v.1.0.0/controller.js` | Widget controller — calls `openUpsellModal` from `myio-js-library` |
| `src/thingsboard/GCDR-Upsell-Setup/v.1.0.0/template.html` | Widget HTML template |
| `src/thingsboard/GCDR-Upsell-Setup/v.1.0.0/styles.css` | Widget styles |
...
**File:** `src/thingsboard/Pre-Setup-Constructor/v.2.0.0/controller.js`
...
<script src="../../src/thingsboard/GCDR-Upsell-Setup/v.1.0.0/controller.js"></script>
```
