...
- MAIN controller (`src/thingsboard/MYIO-SIM/v5.2.0/MAIN/controller.js`) re-exports from `window.MyIOLibrary.DeviceGridWidgetFactory`
...
```javascript
// src/thingsboard/MYIO-SIM/v5.2.0/STORES/controller.js (~60 lines)
...
```javascript
// src/thingsboard/MYIO-SIM/v5.2.0/WATER_COMMON_AREA/controller.js (~70 lines)
...
| `src/thingsboard/MYIO-SIM/v5.2.0/MAIN/controller.js` | EDIT - Re-export from MyIOLibrary | ✅ DONE |
| `src/thingsboard/MYIO-SIM/v5.2.0/STORES/controller.js` | REPLACE (~165 lines) | ✅ DONE |
| `src/thingsboard/MYIO-SIM/v5.2.0/WATER_STORES/controller.js` | REPLACE (~170 lines) | ✅ DONE |
| `src/thingsboard/MYIO-SIM/v5.2.0/WATER_COMMON_AREA/controller.js` | REPLACE (~200 lines) | ✅ DONE |
| `src/thingsboard/MYIO-SIM/v5.2.0/EQUIPMENTS/controller.js` | REPLACE (~315 lines) | ✅ DONE |
