...
1. **`src/thingsboard/MYIO-SIM/v5.2.0/EQUIPMENTS/controller.js`**
   - Add RealTimeService implementation
   - Modify STATE object
   - Add toggle button to toolbar
   - Modify `renderCardComponentHeadOffice`

2. **`src/thingsboard/MYIO-SIM/v5.2.0/EQUIPMENTS/styles.css`** (if exists)
...
1. **`src/thingsboard/MYIO-SIM/v5.2.0/EQUIPMENTS/template.html`**
...
2. **`src/thingsboard/MYIO-SIM/v5.2.0/EQUIPMENTS/style.css`**
...
3. **`src/thingsboard/MYIO-SIM/v5.2.0/EQUIPMENTS/controller.js`**
...
4. **`docs/rfcs/RFC-0093-Equipments-Grid-RealTime-Mode.md`**
