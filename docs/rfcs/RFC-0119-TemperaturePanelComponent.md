...
The existing TEMPERATURE widget (`src/thingsboard/MYIO-SIM/v5.2.0/TEMPERATURE/`) is a ThingsBoard widget that provides:
...
```
src/thingsboard/MYIO-SIM/v5.2.0/TEMPERATURE/
...
- `src/thingsboard/MYIO-SIM/v5.2.0/TEMPERATURE/controller.js` (~940 lines)
