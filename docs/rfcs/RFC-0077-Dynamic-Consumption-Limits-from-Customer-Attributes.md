...
```javascript
// src/thingsboard/MYIO-SIM/V1.0.0/EQUIPMENTS/controller.js (lines 1224-1254)
...
**Location:** `src/thingsboard/MYIO-SIM/V1.0.0/EQUIPMENTS/controller.js` (lines 1228-1254)
...
**Location:** `src/thingsboard/MYIO-SIM/V1.0.0/EQUIPMENTS/controller.js`
...
**Location:** All widgets in `src/thingsboard/MYIO-SIM/V1.0.0/**/controller.js`
...
```javascript
// src/thingsboard/MYIO-SIM/V1.0.0/EQUIPMENTS/controller.js
// src/thingsboard/MYIO-SIM/V1.0.0/STORES/controller.js
// etc.
...
- **EQUIPMENTS Widget**: `src/thingsboard/MYIO-SIM/V1.0.0/EQUIPMENTS/controller.js` (lines 1224-1261)
