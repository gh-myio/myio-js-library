...
Migrate the ThingsBoard-coupled ENERGY widget (`src/thingsboard/MYIO-SIM/v5.2.0/ENERGY/controller.js`) to a standalone, reusable TypeScript component (`src/components/energy-panel/`) following the architecture established by `telemetry-grid`. This enables:
