...
- Caminho: `src/thingsboard/MYIO-SIM/v5.2.0/MAIN/controller.js`
...
- **SIM vs WIDGET:** o simulador (`src/thingsboard/MYIO-SIM/`) é uma cópia do widget de
...
- `src/thingsboard/MYIO-SIM/v5.2.0/MAIN/controller.js` — cópia da regra inline + `buildCategorySummary`
