...
Referências
- Master: `docs/RFC-0053-ELIMINATE-IFRAMES.md`
- Apêndice (M1): `docs/RFC-0053-APENDICE-M1.md`
- Apêndice (Opção B): `docs/RFC-0053-APENDICE-OPCAO-B.md`
- Apêndice (Revert — histórico): `docs/RFC-0053-APENDICE-REVERT-IFRAME.md`
